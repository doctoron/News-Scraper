# All the News That's Fit to Scrape: News-Scraper

### Overview
News scraper allows you to select articles, read news and write your comments.
This app uses express, morgan, mongoose, axios and cheerio to perform web scraping, retrieve articles and inserts them into a mongodb database.  Database schema is defined and created through mongoose and related to comments that the reader can add, update and delete.
